...
I work in Data Science and Research Psychology. I'm excited about learning and teaching all things programming, statistics. I work mostly in R but am comfortable with Python and enjoy working in SQL.
...
I'm also passionate about good science communication and finding the most efficient ways to communicate to other data professionals as well as non-techincal data consumers
```{r,echo=FALSE}
set.seed(456)
control_group <- rnorm(15, 1,.5)
experimental_group <- rnorm(15, 1.5,.5)
